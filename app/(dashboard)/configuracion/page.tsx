      ...
      <div className="bg-[#242424] border border-[#3A3A3A] rounded-xl overflow-hidden">
        <div className="px-5 py-4 border-b border-[#3A3A3A] flex flex-wrap items-center justify-between gap-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-[#CC2229] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#991A1E]"
          >
            <Plus size={16} />
            Crear usuario ERP
          </button>
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="rounded-lg p-2 text-gray-400 transition-colors hover:bg-[#1A1A1A] hover:text-[#CC2229]"
        ...
        <div className="fixed inset-0 z-[100] flex min-h-dvh w-screen items-center justify-center overflow-y-auto bg-black/75 p-4 backdrop-blur-sm">
          ...
          <div className="relative z-10 my-8 w-full max-w-5xl max-h-[90vh] overflow-y-auto rounded-xl border border-[#3A3A3A] bg-[#242424] shadow-2xl">
            <div className="sticky top-0 z-10 flex items-center justify-between gap-4 border-b border-[#3A3A3A] bg-[#242424] px-6 py-4">
              ...
              <button onClick={() => setUserDraft(null)} className="text-gray-400 hover:text-white">
                Cerrar
              </button>
            </div>
            ...
            <div className="sticky bottom-0 flex justify-end gap-3 border-t border-[#3A3A3A] bg-[#242424] px-6 py-4">
              <button onClick={() => setUserDraft(null)} className="rounded-lg border border-[#3A3A3A] px-4 py-2 text-sm text-gray-400 hover:text-white">
                Cancelar
              </button>
              <button onClick={saveUserDraft} className="rounded-lg bg-[#CC2229] px-4 py-2 text-sm text-white hover:bg-[#991A1E]">
                Guardar usuario
              </button>
            </div>
          </div>
